...
- [X] T060 Joan's review of the second preview: "muy fachero", but too much space between sections. Section padding from `py-20 md:py-28` to `py-12 md:py-16`, story to `py-8 md:py-10`, footer to `py-16`; DESIGN.md spacing rule amended with the reason
